...
import { IZeusNavigationTiming } from "../typings/types";
 ...
 */
export const getNavigationTiming = (): IZeusNavigationTiming => {
  ...
  const n = window.performance.getEntriesByType("navigation")[0] as any;
